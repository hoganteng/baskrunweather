 ...
 */
public class BashRunDB {
	/** 数据库名称 */
	public static final String DB_NAME="BaskRunWeather";
	/** 数据库版本 */
	public static final int VERSION=1;
	private static BashRunDB bashRunDB;
	...
	private BashRunDB(Context context){
		dbHelper=new BaskRunOpenHelper(context,"", null,VERSION);
	 ...
	 * @return BashRunDB
	 */
	public synchronized static BashRunDB getInstance(Context context){
		if (bashRunDB==null) {
			bashRunDB=new BashRunDB(context);
		}
		return bashRunDB;
	}
	/**
